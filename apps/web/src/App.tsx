...
import DatasetWorkspacePanel from "./DatasetWorkspacePanel";
...
export default function App() {
  ...
  const viewCopy: Record<ViewId, { eyebrow: string; title: string; description: string }> = {
    ...
    evaluate: { eyebrow: "Prove the result", title: "Evaluate", description: "Compare the trained adapter with the reference model on held-out tasks using checks matched to the project’s programming language." },
          ...
          <main className="page-content">
            ...
            {activeView === "projects" ? (
              ...
              <div className="data-workspace" key={`data-${projects?.active_id}-${projectScopeRevision}`}>
                ...
                <DatasetWorkspacePanel refreshKey={sourceRevision} onDatasetChanged={projectChanged} disabled={trainingActive} />
